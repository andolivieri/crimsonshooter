...
void TextComponent::draw()
{
    ...
    SDL_Texture* Message = SDL_CreateTextureFromSurface(TextureManager::renderer, surfaceMessage);
    ...
    SDL_RenderCopy(TextureManager::renderer, Message, NULL, &Message_rect);
